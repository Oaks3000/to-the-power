...
import type { ScenarioSummary } from "../application/scenario-runner.js";

function makeSummary(seed: number, overrides: Partial<ScenarioSummary["metrics"]> = {}): ScenarioSummary {
  return {
